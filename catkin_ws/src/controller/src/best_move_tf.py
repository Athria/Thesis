...
class square:
	...
	print first
		...
		((new_x,y,z), rot) = self.listener.lookupTransform('world', 'turtle1', rospy.Time(0))
	...
	first = 1
		...
		try:
            		((x,y,z), rot) = self.listener.lookupTransform('world', 'turtle1', rospy.Time(0))
