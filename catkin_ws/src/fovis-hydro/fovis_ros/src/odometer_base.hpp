...
protected:
      ...
      const sensor_msgs::CameraInfoConstPtr& info_msg)
  {
    ...
    odom_msg_.child_frame_id = base_footprint_frame_id_;
    
    pose_msg_.header.stamp = image_msg->header.stamp;
    pose_msg_.header.frame_id = base_footprint_frame_id_;
    ...
    if (status == fovis::SUCCESS)
    {
      ...
      if (publish_tf_)
      {
        tf_broadcaster_.sendTransform(
            ...
            odom_frame_id_, base_footprint_frame_id_));
      }
...
private:
  ...
  void loadParams()
  {
    ...
    nh_local_.param("base_footprint_frame_id", base_footprint_frame_id_, std::string("/base_footprint"));
      ...
      const std::string& sensor_frame_id, tf::StampedTransform& base_to_sensor)
  {
    ...
    if (tf_listener_.canTransform(
          base_footprint_frame_id_, sensor_frame_id, stamp, &error_msg))
    {
